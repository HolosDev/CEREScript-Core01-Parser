...
case_readVII_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tVII_01)
  (Right (vVII_01, ""))
  readVariableIndex
  tVII_01
vVIN_01 = VIN "=ABC"
...
case_readVIN_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tVIN_01)
  (Right (vVIN_01, ""))
  readVariableIndex
  tVIN_01
vVIIT_01 = VIIT (-1) 2
...
case_readVIIT_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tVIIT_01)
  (Right (vVIIT_01, ""))
  readVariableIndex
  tVIIT_01
vVINT_01 = VINT "CRH" (-4)
...
case_readVINT_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tVINT_01)
  (Right (vVINT_01, ""))
  readVariableIndex
  tVINT_01
...
case_readVIIRI_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tVIIRI_01)
  (Right (vVIIRI_01, ""))
  readVariableIndex
  tVIIRI_01
...
case_readVINRI_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tVINRI_01)
  (Right (vVINRI_01, ""))
  readVariableIndex
  tVINRI_01
...
case_readVIIRIT_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tVIIRIT_01)
  (Right (vVIIRIT_01, ""))
  readVariableIndex
  tVIIRIT_01
...
case_readVINRIT_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tVINRIT_01)
  (Right (vVINRIT_01, ""))
  readVariableIndex
  tVINRIT_01
...
case_readVIV_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tVIV_01)
  (Right (vVIV_01, ""))
  readVariableIndex
  tVIV_01
...
case_readVIAtom_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tVIAtom_01)
  (Right (vVIAtom_01, ""))
  readVariableIndex
  tVIAtom_01
...
case_readVINull_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tVINull_01)
  (Right (vVINull_01, ""))
  readVariableIndex
  tVINull_01
...
case_readPVII_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tPVII_01)
  (Right (vPVII_01, ""))
  readVariableIndex
  tPVII_01
...
case_readPVIN_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tPVIN_01)
  (Right (vPVIN_01, ""))
  readVariableIndex
  tPVIN_01
...
case_readPVIT_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tPVIT_01)
  (Right (vPVIT_01, ""))
  readVariableIndex
  tPVIT_01
...
case_readPVIIRI_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tPVIIRI_01)
  (Right (vPVIIRI_01, ""))
  readVariableIndex
  tPVIIRI_01
...
case_readPVIIRIT_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tPVIIRIT_01)
  (Right (vPVIIRIT_01, ""))
  readVariableIndex
  tPVIIRIT_01
...
case_readPVINRIT_01 = eqParsingTester
  (T.unpack $ T.append "Read VariableIndex " tPVINRIT_01)
  (Right (vPVINRIT_01, ""))
  readVariableIndex
  tPVINRIT_01
...
case_readIntValue01 = eqParsingTester
  (T.unpack $ T.append "Reading valid & positive IntValue " tIntValue01)
  (Right (vIntValue01, ""))
  parseValue
  tIntValue01
...
case_readIntValue02 = eqParsingTester
  (T.unpack $ T.append "Reading valid & negative IntValue " tIntValue02)
  (Right (vIntValue02, ""))
  parseValue
  tIntValue02
...
case_readIntValue03 = eqParsingTester
  ( T.unpack
  $ T.append "Bypass unreadable text after reading IntValue " tIntValue03
  )
  (Right (vIntValue03, " |>)))"))
  parseValue
  tIntValue03
...
case_readDblValue01_1 = eqParsingTester
  (T.unpack $ T.append "Reading valid & positive DblValue " tDblValue01_1)
  (Right (vDblValue01_1, ""))
  parseValue
  tDblValue01_1
...
case_readDblValue01_2 = eqParsingTester
  (T.unpack $ T.append "Reading valid & positive DblValue " tDblValue01_2)
  (Right (vDblValue01_2, ""))
  parseValue
  tDblValue01_2
...
case_readDblValue02_1 = eqParsingTester
  (T.unpack $ T.append "Reading valid & negative DblValue " tDblValue02_1)
  (Right (vDblValue02_1, ""))
  parseValue
  tDblValue02_1
...
case_readDblValue02_2 = eqParsingTester
  (T.unpack $ T.append "Reading valid & negative DblValue " tDblValue02_2)
  (Right (vDblValue02_2, ""))
  parseValue
  tDblValue02_2
...
case_readDblValue03_1 = eqParsingTester
  ( T.unpack
  $ T.append "Bypass unreadable text after reading DblValue" tDblValue03_1
  )
  (Right (vDblValue03_1, " |>)))"))
  parseValue
  tDblValue03_1
...
case_readBoolValue01_1 = eqParsingTester
  (T.unpack $ T.append "Reading valid True  BoolValue" tBoolValue01_1)
...
case_readBoolValue01_2 = eqParsingTester
  (T.unpack $ T.append "Reading valid true  BoolValue" tBoolValue01_2)
...
case_readBoolValue02_1 = eqParsingTester
  (T.unpack $ T.append "Reading valid False BoolValue" tBoolValue02_1)
...
case_readBoolValue02_2 = eqParsingTester
  (T.unpack $ T.append "Reading valid false BoolValue" tBoolValue02_2)
...
case_readAtomValue01 = eqParsingTester
  (T.unpack $ T.append "Reading valid AtomValue" tAtomValue01)
  (Right (vAtomValue01, ""))
  parseValue
  tAtomValue01
...
case_readArrValue01 = eqParsingTester
  (T.unpack $ T.append "Reading valid ArrValue" tArrValue01)
  (Right (vArrValue01, "o"))
  parseValue
  tArrValue01
